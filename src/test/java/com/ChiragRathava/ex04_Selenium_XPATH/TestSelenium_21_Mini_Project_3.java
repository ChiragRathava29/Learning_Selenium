...
package com.ChiragRathava.ex04_Selenium_XPATH;
...
public class TestSelenium_21_Mini_Project_3 {
...
//        username_input_box_xpath.sendKeys("John Doe");
        ...
        WebElement login_input_box_xpath_id = driver.findElement(By.xpath("//button[@id='btn-login']"));
        login_input_box_xpath_id.click();
